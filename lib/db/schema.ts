...
// Documents table (local file storage metadata)
export const documents = pgTable(
  'documents',
  {
    ...
    originalMimeType: varchar('original_mime_type', {
      length: VARCHAR_LENGTH
    }).notNull(),
  ...
  table => [
    ...
    pgPolicy('users_manage_own_documents', {
      as: 'permissive',
      for: 'all',
      to: 'public',
      using: sql`user_id = (select current_setting('app.current_user_id', true))`,
...
export const formTemplates = pgTable(
  ...
  table => [
    ...
    pgPolicy('users_manage_own_form_templates', {
      as: 'permissive',
      for: 'all',
      to: 'public',
      using: sql`user_id = (select current_setting('app.current_user_id', true))`,
